# Schema Repair — 360 Call B: Semantic Selection
...
You were asked to evaluate 360 residual candidates against the full exploration trajectory and return exactly one selection per candidate.
